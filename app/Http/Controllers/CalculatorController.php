...
class CalculatorController extends Controller
{
    ...
    public function index(){
     ...
     public function inputdriver(){
        $calc = DB::table('calc')->get();
        return view('calculator.driverinput', ['calc'=>$calc]);
    }

    public function inputstaff(){
        $calc = DB::table('calc')->get();
        return view('calculator.staffinput', ['calc'=>$calc]);
    }
    ...
    public function tampstaff(){
        ...
        ->select('no','name','position','location','pdate','knowledge','wspeed','wsoul','wqual','wpress','teamwork','communicate','responbility','learning','dicipline','initiative','creativity','honestly','obedience','loyalty','total')
