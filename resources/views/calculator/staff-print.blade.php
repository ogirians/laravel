...
<table id="customers">
    ...
    <tr>
      <td style="min-height: 40px; padding-bottom: 30px;">  
        <span style="word-wrap: break-word;">{{ $c -> rekomend3 }}</span>
      </td>
    </tr>
    ...
    <tr>
      <td style="min-height: 40px; padding-bottom: 30px;">
        <span style="word-wrap: break-word;">{{ $c -> rekomend4 }}</span>
      </td>    
    </tr>
    ...
    <tr> 
      <td style="min-height: 40px; padding-bottom: 30px;">
       <span style="word-wrap: break-word;">{{ $c -> rekomend5 }}</span>
      </td>
   </tr>
