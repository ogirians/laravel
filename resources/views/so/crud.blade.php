  ...
  <link href="{{ asset('/kuning/css/slide_bukti.css')}}" rel="stylesheet">
        <div class="card shadow mb-4" style="margin-bottom: 0.0rem !important;">
                ...
                <div class="collapse show" id="collapseCardExample">
                  ...
                  <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="/so/filter" method="GET" style="max-height: 150px;">
                          ...
                          <button class="btn btn-info btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Action
                             ...
                             <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                              <a href="/so/edit/{{ $m->no }}" class="dropdown-item">Edit</a>
