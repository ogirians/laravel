            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <!-- Bar Chart -->
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Statistik periode : {{ Carbon\Carbon::parse($d->start)->format('d-m-Y') }}   sampai {{ Carbon\Carbon::parse($d->end)->format('d-m-Y') }}</h6>
                </div>
                <div class="card-body">
                  <div class="chart-bar">
                    <canvas id="dan"></canvas>
                  </div>
                  <hr>
                ...
                <div class="card shadow mb-4" style="max-width: 800px;">
                   <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Rekapan periode : {{ Carbon\Carbon::parse($d->start)->format('d-m-Y') }}   sampai {{ Carbon\Carbon::parse($d->end)->format('d-m-Y') }}</h6>  
             ...
             @endforeach   
                 ...
                 <div class="card-body" style="margin-bottom: 15px;">  
                  ...
                  <table  class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($score as $s)
                    <tr>
                      <td><a href="/berita/{{ $s->outlet }}">{{ $s->outlet }}</a></td>
