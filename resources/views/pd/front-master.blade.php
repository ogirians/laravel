  ...
  <!-- Page Wrapper -->
    ...
    <!-- Content Wrapper -->
      ...
      <div id="content">
        ...
        <div class="row" style="background-color: white; padding-top:10px; margin-bottom: 10px;  box-shadow: 10px 5px 15px 4px #ccccccb3; ">
        <div class="col" style="text-align: center;">
        <img width="80px" height="70px" src="/kuning/img/logo_ibi.png">
        <div class="topbar-divider d-none d-sm-block"></div>
        </div>
        <div class="col" style="text-align: center; ">
           <a href="/all"><h1>IBI FM</h1></a>
        </div>
        <div class="topbar-divider d-none d-sm-block"></div>
        <div class="col" style="text-align: center;">
           <img width="80px" height="60px" src="/kuning/img/logi_okt.jpg" style="margin-bottom: 10px">
        </div>
        </div> 
      </div>
        <!-- End of Topbar -->
...
<div class="container-fluid2" style="min-height: 500px; padding-top: 50px; padding-bottom: 50px;padding-right: 5%;padding-left: 5%;">
...
@yield('konten')
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Indoberkainvestama 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="/kuning/js/demo/chart-front.js"></script>
