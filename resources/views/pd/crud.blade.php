                ...
                <div class="collapse show" id="collapseCardExample">
                  <div class="card-body">
                        <div class="container" style="padding-left:0px; ">
           				<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="/dosa/filter" method="GET" style="max-height: 150px;">
...
<div class="card shadow mb-4">
   <div class="card-header py-3">
    <h3>Buku Berita Acara </h3>  
    <a class="btn btn-success" href="/dosa/tambah"> + Tambah Berita Acara</a>
    
    @if ($mulai !== null && $selesai !== null && $loc !== null)
    <a class="btn btn-info" href="/dosap/excel/{{ $mulai }}/{{ $selesai }}/{{ $loc }}"> + Export to Excell</a>
    @else
    <a class="btn btn-info" href="/dosap/excel/null/null/null"> + Export to Excell</a>
    @endif
      ...
      <td>
            ...
            @endif
                 ...
                 <?php foreach (json_decode($m->bukti) as $picture) { ?>
                        <img src="{{ asset('/data_bukti/'.$picture) }}" style="width:75px"/>
                         ...
                         <?php foreach (json_decode($m->bukti)as $picture) { ?>
                            <div class="mySlides_{{$m->no}}">
                              <div class="numbertext" style="color: black;">{{$urut}} / {{ $total }}</div>
                               <img src="{{ asset('/data_bukti/'.$picture) }}" width="400px" height="500px">
                            </div>
                        @php
                        $urut++;
                        @endphp
            ...
            @else
             ...
             <img width="75px" src="{{ url('data_bukti/'.$m->bukti) }}">
              </a>
               ...
               <div class="modal fade" id="myModal_{{ $m->no }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <center>  
                          <img width="400px" height="500px" src="{{ url('data_bukti/'.$m->bukti) }}" alt="" class="img-responsive">
                        </center>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> 
                          ...
                          <button class="btn btn-info btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Action
                             ...
                             <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                              <a href="/dosa/edit/{{ $m->no }}" class="dropdown-item">Edit</a>
                                <a onclick="return confirm('Yakin ingin menghapus data pelamar ?')" href="/dosa/delete/{{ $m->no }}" class="dropdown-item">Hapus</a>
