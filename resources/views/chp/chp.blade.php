...
@section('content')
	...
	<h1>Cek Harga Pasar</h1>
	<!-- Start .nav nav-tabs -->
	<ul class="nav nav-tabs" role="tablist">
		<li role="presenstation" class="active"><a href="#view" aria-controls="view" role="tab" data-toggle="tab"><strong>Rekap Cek Harga Pasar</strong></a></li>
		<li role="presenstation"><a href="#create" aria-controls="create" role="tab" data-toggle="tab"><strong>Input Cek Harga Pasar</strong></a></li>
	</ul>
	<!-- End .nav nav-tabs -->
	...
	<div class="tab-content">
					...
					@endphp
					  ...
					  <tr>
						...
						@if ($order->status == 0 && $order->deliver == 0 && (Auth::user()->isBowner() || (Auth::user()->isEmployee() && $order->user_id == Auth::user()->id)))
							<!-- Edit button -->
							<a class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="left" title="view/edit order detail" href="{{ route('chp.edit', $order->id) }}"><span class="glyphicon glyphicon-pencil"></span></a>
						@else
							<!-- Disable Edit button -->
		...
		<div role="tabpanel2" class="tab-pane fade" id="create" style="padding: 20px;">
			...
			{!! Form::open(['method'=>'POST', 'action'=>'ChpController@store', 'class'=>'form-group']) !!}
