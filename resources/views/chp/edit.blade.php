	...
	<div class="tab-content">
		...
		<div role="tabpanel1" class="tab-pane fade in active" id="view">
			...
			<table class="table table-responsive table-bordered table-striped">
		  	...
		  	<a href="{{ url('chp') }}" class="btn btn-info"><span class="glyphicon glyphicon-chevron-left"></span> Back to Orders</a>
		</div>
		...
		<div role="tabpanel2" class="tab-pane fade" id="create" style="padding: 20px;">
			...
			{!! Form::model($order, ['method'=>'PATCH', 'action'=>['ChpController@update', $order->id]]) !!}
